...
mydata1 <- mydata[mydata$Area == "Zone4", ]
mydata1
...
mydata1 <- mydata1[mydata1$Area=="Zone4"]
...
# 导出到 PNG 文件
png("D:/毕业/方案二/Figure/newFigure1/Zone4.png", height = 20, width = 18, units = "cm", res = 600)  # 设置文件名和图像尺寸
grid.arrange(left, p2, ncol = 2)  # heights 参数设置图形的相对高度比例
dev.off()

pdf("D:/毕业/方案二/Figure/newFigure1/Zone4.pdf", height = 7, width = 5)  # 设置文件名和图像尺寸
grid.arrange(left, p2, ncol = 2)  # heights 参数设置图形的相对高度比例
dev.off()
